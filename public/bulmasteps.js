(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["bulmaSteps"] = factory();
  else root["bulmaSteps"] = factory();
  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__defaultOptions__ = __webpack_require__(
          2
        );
        var _extends =
          Object.assign ||
        ...
        var bulmaSteps = (function (_EventEmitter) {
          ...
          function bulmaSteps(selector) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (bulmaSteps.__proto__ || Object.getPrototypeOf(bulmaSteps)).call(
                this
              )
            );
            ...
            [
                ...
                value: function _bindEvents() {
                  ...
                  if (this.previous_btn != null) {
                    this._clickEvents.forEach(function (event) {
                      _this2.previous_btn.addEventListener(
                        event,
                        _this2[onStepsPrevious],
                        false
                      );
                    });
                  }
                  ...
                  if (this.next_btn != null) {
                    this._clickEvents.forEach(function (event) {
                      _this2.next_btn.addEventListener(
                        event,
                        _this2[onStepsNext],
                        false
                      );
              ...
              },
              {
                ...
                value: function activate_step(step_id) {
                  ...
                  if (typeof this.contents[step_id] !== "undefined") {
                    this.contents[step_id].classList.add(
              ...
              },
              {
                ...
                value: function complete_step(step_id) {
                  this.steps[step_id].classList.add(
              ...
              },
              {
                ...
                value: function uncomplete_step(step_id) {
                  this.steps[step_id].classList.remove(
                    this.options.completed_class
                  );
              ...
              },
              {
                ...
                value: function deactivate_step(step_id) {
                  ...
                  if (typeof this.contents[step_id] !== "undefined") {
                    this.contents[step_id].classList.remove(
                      this.options.active_class
                    );
                  }
                },
